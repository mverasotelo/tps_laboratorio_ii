...
namespace TestUnitarios
{
    ...
    public class UnitTest
    {
        ...
        {
            //arrange
            Bovino bovino = new Bovino(1000, DateTime.Today, Bovino.ESexo.Hembra, Bovino.ERaza.Angus, Bovino.EUso.Tambo);
        ...
        {
            //arrange
            Bovino bovino = new Bovino(DateTime.Today, Bovino.ESexo.Hembra, Bovino.ERaza.Angus, Bovino.EUso.Tambo);

            int expected = 1;

            //act
            int actual = bovino.FechaIngreso.CalcularPermanenciaEnDias();

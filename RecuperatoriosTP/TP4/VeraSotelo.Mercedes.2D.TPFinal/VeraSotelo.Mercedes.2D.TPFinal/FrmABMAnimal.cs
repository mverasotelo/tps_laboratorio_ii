...
namespace VeraSotelo.Mercedes._2D.TPFinal
{
    public partial class FrmABMAnimal : Form
    {
        ...
        private void FrmABMAnimal_Load(object sender, EventArgs e)
        {
            ...
            {
                Text = "Agregar animal";
                txtId.Text = (BovinoDAO.ObtenerProximoId()).ToString();
            }
            else
            {
        ...
        {
            Bovino.ESexo sexo = Bovino.ESexo.Hembra;
            ...
            foreach (Control c in gpbSexo.Controls)
            {
                ...
                bovino = new Bovino(Convert.ToInt32(txtId.Text),DateTime.Today, sexo, raza, uso);
        ...
        {
            txtId.Text = bovino.Identificacion.ToString();
